...
int main(int argc, char *argv[])
{
  ...
  for (frames = 0; frames < 30; frames++)
  {
    ...
    sprintf(filename, "p7_tetrahedron_scene%04d.ppm", frames);
  ...
  system("convert -delay 10 p7_tetrahedron_scene*.ppm ../images/tetrahedron.gif");
  system("rm -f p7_tetrahedron_scene*");
