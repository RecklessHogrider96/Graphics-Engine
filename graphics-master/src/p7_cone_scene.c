...
int main(int argc, char *argv[])
{
  ...
  for (frames = 0; frames < 30; frames++)
  {
    ...
    sprintf(filename, "p7_cone_scene%04d.ppm", frames);
  ...
  system("convert -delay 10 p7_cone_scene*.ppm ../images/cone.gif");
  system("rm -f p7_cone_scene*");
